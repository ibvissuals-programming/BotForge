...
export const getSendChatMessageMutationOptions = <TError = ErrorType<ChatError>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SendChatMessageMutationError = ErrorType<ChatError>

    /**
 * @summary Send a message and get an AI response
 */
export const useSendChatMessage = <TError = ErrorType<ChatError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendChatMessage>>, TError,{data: BodyType<ChatMessageInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
